...
export default function DisplayComment({
    ...
    const [currentComment, setCurrentComment] = useState<CommentWithNestedReplies>(comment);
    const [replies, setReplies] = useState<CommentWithNestedReplies[]>(comment.replies);
    ...
    const fetchAllReplies = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setError(
                    errorData.error ||
                        'Antworten konnten nicht abgerufen werden'
                );
            }
        } catch (error) {
