    ...
    return (
        <>
            <header id="header" className="group">
                <nav
                    className="fixed overflow-hidden z-20 w-full border-b dark:border-gray-600 bg-white/50 dark:bg-gray-950/50 backdrop-blur-2xl">
                        ...
                        <div className="flex flex-wrap items-center justify-between py-2 sm:py-4">
                            <div className="w-full items-center flex justify-between lg:w-auto">
                                <h1 className={"text-xl font-bold"}>
                                    <Link href={"/"} className={"hover:link md:px-4 block dark:text-white"}>
                                        Polititracker
                                    </Link>
                                </h1>
                            ...
                            <div
                                ...
                                <div
                                    className={"border-r h-[35px] w-1 dark:border-gray-600 border-gray-400 mr-3"}></div>

                                <div
                                    className="w-full gap-2 pt-6 pb-4 lg:pb-0 items-center flex flex-col lg:flex-row lg:w-fit lg:pt-0 lg:pl-2">
                                    {user != null ?
                                        <>
                                            <Link href={"/auth/sign-out"}
                                                  className={"bg-red-800 dark:bg-red-900 hover:bg-red-700 dark:hover:bg-red-800 transition-colors text-white rounded px-3 py-1.5"}>
                                                Abmelden
                                            </Link>
                                        </>
                                        :
                                ...
                                <div
                                    className={"border-r h-[35px] w-1 dark:border-gray-600 border-gray-400 mr-3 ml-3"}></div>
