...
export default function SignUpPage() {
    ...
    return (
        <>
            <div className={"fixed w-full h-full top-0 left-0 z-[-2] dark:bg-gray-950"}>
                <img src={"/img/plenum.jpg"} className={"fixed w-full h-full opacity-[5%] dark:opacity-[5%]"}/>
            </div>
            <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    <h2 className="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900 dark:text-white">Konto
                        Erstellen</h2>
                </div>
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form className="space-y-6" action={signUp}>
                        <div>
                            <label htmlFor="email"
                                   className="block text-sm/6 font-medium text-gray-900 dark:text-white">Vorname</label>
                            <div className="mt-2">
                        ...
                        <div>
                            <label htmlFor="email"
                                   className="block text-sm/6 font-medium text-gray-900 dark:text-white">Nachname</label>
                            <div className="mt-2">
                        ...
                        <div>
                            <label htmlFor="email"
                                   className="block text-sm/6 font-medium text-gray-900 dark:text-white">E-Mail
                                Adresse</label>
                            <div className="mt-2">
                        ...
                        <div>
                            <div className="flex items-center justify-between">
                                <label htmlFor="password"
                                       className="block text-sm/6 font-medium text-gray-900 dark:text-white">Passwort</label>
                            </div>
                            <div className="mt-2">
                        ...
                        <div>
                            <div className="flex items-center justify-between">
                                <label htmlFor="password"
                                       className="block text-sm/6 font-medium text-gray-900 dark:text-white">Passwort
                                    Bestätigen</label>
                            </div>
                            <div className="mt-2">
                        ...
                        <div className="flex items-center">
                            ...
                            <label htmlFor="checked-checkbox"
                                   className="ms-2 text-sm font-medium text-gray-900 dark:text-white">Nutzungbedingungen
                                gelesen</label>
                        </div>
