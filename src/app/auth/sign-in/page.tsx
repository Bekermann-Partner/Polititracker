...
export default function SignInPage() {
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        if (!res) {
            ...
            console.error("Failed to get user with these credentials!")
            return;
        }
    ...
    return (
        <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                <h2 className="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Melde dich mit deinem Konto an</h2>
            </div>
                    ...
                    <div>
                        <div className="flex items-center justify-between">
                            ...
                            <div className="text-sm">
                                <a href="#" className="font-semibold text-indigo-600 hover:text-indigo-500">Passwort vergessen?</a>
                            </div>
                        </div>
                        <div className="mt-2">
