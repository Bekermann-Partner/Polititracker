...
import {ETheme, getTheme, LOCALSTORAGE_THEME_KEY} from "@/_lib/providers/themeProvider";
...
export function ThemeSelector() {
    ...
    return (
        <div onClick={toggleTheme}
             className={"hover:cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-700 p-1.5 rounded-full transition-colors"}>
            {theme === ETheme.LIGHT && <FaMoon size={20} className={"text-gray-700"}/>}
