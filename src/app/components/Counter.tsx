...
export function Counter({initialValue, finalValue, text}: { initialValue: number, finalValue: number, text?: string }) {
    ...
    return <h1 className={"text-3xl font-semibold"}>{count}{text}</h1>;
}